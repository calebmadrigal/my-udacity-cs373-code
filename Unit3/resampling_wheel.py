# Resampling wheel algorithm - used to generate a new set of particles
# by randomly drawing from an old set of particles (with replacement).
# The particle weight determines the likelihood of it being picked.
